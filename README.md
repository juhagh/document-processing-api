...
This project is a portfolio backend project built to demonstrate employable .NET backend skills beyond basic CRUD APIs, including:
...
1. Client submits a document job to `POST /api/jobs`
